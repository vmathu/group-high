...
function Podcast() {
  return (
    <div>
        <h2 class="header" style={{fontSize:30, fontFamily: "Readex Pro"}} id="podcast">
          Định nghĩa: Podcast được ghép từ "iPod" và "Broadcast" 
        </h2>
